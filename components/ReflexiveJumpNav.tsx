...
import { reflexiveSectionsByCategory } from "@/content/reflexive";

export function ReflexiveJumpNav() {
  ...
  return (
    <details ref={detailsRef} className="confusions-jump">
      <summary className="confusions-jump__summary">
        ...
        <span className="confusions-jump__summary-hint">9 sections</span>
      </summary>

      <div className="confusions-jump__panel">
        {reflexiveSectionsByCategory().map(({ category, sections }) => (
