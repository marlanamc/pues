...
import { verbSectionsByCategory } from "@/content/verbs";

export function VerbsJumpNav() {
  ...
  return (
    <details ref={detailsRef} className="confusions-jump">
      <summary className="confusions-jump__summary">
        ...
        <span className="confusions-jump__summary-hint">11 sections</span>
      </summary>

      <div className="confusions-jump__panel">
        {verbSectionsByCategory().map(({ category, sections }) => (
