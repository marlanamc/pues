...
import {
  markSections,
  markSectionsByCategory,
} from "@/content/accentMarks";

export function AccentMarksJumpNav() {
    ...
    <details ref={detailsRef} className="confusions-jump">
      <summary className="confusions-jump__summary">
        ...
        <span className="confusions-jump__summary-hint">
          {markSections.length} sections
        </span>
      </summary>

      <div className="confusions-jump__panel">
        {markSectionsByCategory().map(({ category, sections }) => (
