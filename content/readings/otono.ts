...
export const otonoReadingDays: ReadingDay[] = [
  ...
  },
  {
    ...
    vocab: [
      ...
      { es: "prestado/a", en: "borrowed", example: "Le presté unas cajas." },
  ...
  },
  {
    ...
    dialogue: {
      ...
      lines: [
        ...
        { speaker: "B", es: "Es normal en los primeros días. ¿Está bien, aunque sea?", en: "That's normal the first days. Is she okay, at least?" },
  ...
  },
  {
    ...
    dialogue: {
      ...
      lines: [
        ...
        { speaker: "B", es: "Exacto. Y al final, el equipo la invitó a almorzar. Se sintió incluida.", en: "Exactly. And in the end, the team invited her to lunch. She felt included." },
      ],
    },
  },
  {
    ...
    vocab: [
      ...
      { es: "el café", en: "the coffee shop", example: "Encontró un café favorito." },
    ...
    dialogue: {
      ...
      lines: [
        ...
        { speaker: "A", es: "Mucho mejor. Ya tiene una rutina y encontró un café favorito cerca del trabajo.", en: "Much better. She has a routine now and found a favorite coffee shop near work." },
  ...
  },
  {
    ...
    dialogue: {
      ...
      lines: [
        ...
        { speaker: "B", es: "Espera, hay más. Tuvo un primer día difícil, pero pidió ayuda. Y ahora, un mes después, tiene amigos, una rutina y un café favorito.", en: "Wait, there's more. She had a hard first day, but she asked for help. And now, a month later, she has friends, a routine, and a favorite coffee shop." },
