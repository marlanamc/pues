...
export const priWeek3SentenceFormerDays: SentenceFormerDay[] = [
  ...
  {
    day: 294,
    theme: "El supermercado el domingo",
    stems: [
      {
        stem: "Me muero de…",
        english: "I'm dying of…",
        completions: [
          { es: "sed y hay una sola caja abierta", en: "thirst and there's one register open", category: "other" },
          { es: "calor con el abrigo puesto adentro", en: "heat with my coat on inside", category: "other" },
          { es: "hambre y todavía no llego a la caja", en: "hunger and i'm still not at the register", category: "food" },
          { es: "aburrimiento en esta fila", en: "boredom in this line", category: "other" },
          { es: "risa con el letrero de la caja", en: "laughter at the sign on the register", category: "other" },
        ],
      },
      {
        stem: "Tardé mil años",
        english: "It took me forever",
        completions: [
          { es: "solo en encontrar el arroz", en: "just to find the rice", category: "food" },
          { es: "porque cambiaron todo de lugar", en: "because they moved everything", category: "other" },
          { es: "en la fila y salí con tres cosas", en: "in line and left with three things", category: "time" },
          { es: "buscando estacionamiento", en: "looking for parking", category: "activity" },
          { es: "y ni compré lo que venía a comprar", en: "and i didn't even buy what i came for", category: "other" },
        ],
      },
      {
        stem: "Es lo mejor del mundo",
        english: "It's the best thing in the world",
        completions: [
          { es: "encontrar mangos en marzo", en: "finding mangoes in march", category: "food" },
          { es: "que abran la segunda caja", en: "when they open the second register", category: "other" },
          { es: "el pan caliente a las nueve", en: "warm bread at nine", category: "food" },
          { es: "salir con todo en una sola bolsa", en: "leaving with everything in one bag", category: "activity" },
          { es: "que el carrito ruede derecho", en: "when the cart rolls straight", category: "other" },
        ],
      },
      {
        stem: "Es lo peor del mundo",
        english: "It's the worst thing in the world",
        completions: [
          { es: "la caja automática que te grita", en: "the self-checkout that yells at you", category: "other" },
          { es: "el carrito con la rueda mala", en: "the cart with the bad wheel", category: "other" },
          { es: "olvidar una cosa y tener que volver", en: "forgetting one thing and having to go back", category: "activity" },
          { es: "la fila del domingo a mediodía", en: "the sunday noon line", category: "time" },
          { es: "que se te rompa la bolsa en el parqueo", en: "when the bag breaks in the parking lot", category: "other" },
        ],
      },
      {
        stem: "Es una barbaridad",
        english: "It's outrageous",
        completions: [
          { es: "lo que cobran por una libra de tomates", en: "what they charge for a pound of tomatoes", category: "food" },
          { es: "que el café cueste más que la carne", en: "that coffee costs more than meat", category: "food" },
          { es: "y aun así lo compré", en: "and i bought it anyway", category: "other" },
          { es: "lo que ha subido todo desde enero", en: "how much everything has gone up since january", category: "time" },
          { es: "pagar tres dólares por un aguacate", en: "paying three dollars for an avocado", category: "food" },
        ],
      },
    ],
  },
