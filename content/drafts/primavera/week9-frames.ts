...
export const priWeek9FrameDays: FrameDay[] = [
  ...
  {
    day: 336,
    theme: "Profundizar: El hermano de Camila",
    subtitle: "Roles reversed. Camila drops one sentence about her brother and Marlana does the digging.",
    frames: [
      {
        stem: "¿Y eso?…",
        english: "And that? / How come? — asking why, from nowhere",
        scenarios: ["the news out of nowhere", "first reaction", "opening the door"],
        examples: [
          "¿Y eso? ¿Tu hermano se viene para acá?",
          "¿Y eso? ¿Desde cuándo lo estaban planeando?",
          "¿Y eso? ¿Y tú por qué no me habías dicho nada?",
        ],
      },
      {
        stem: "¿Cómo así?…",
        english: "How so? / What do you mean?",
        scenarios: ["the detail that doesn't add up", "job or no job", "pressing gently"],
        examples: [
          "¿Cómo así? ¿Consiguió el trabajo o se viene sin nada?",
          "¿Cómo así? ¿Se viene solo o con la familia?",
          "¿Cómo así? ¿Y el visado ya está resuelto?",
        ],
      },
      {
        stem: "¿Y qué pasó con…?",
        english: "And what happened with…?",
        scenarios: ["what he's leaving behind", "the apartment", "the loose end"],
        examples: [
          "¿Y qué pasó con el apartamento que tenía en Medellín?",
          "¿Y qué pasó con el trabajo de allá, renunció?",
          "¿Y qué pasó con el carro? ¿Lo vendió?",
        ],
      },
      {
        stem: "¿Y después?…",
        english: "And then? / And after that?",
        scenarios: ["who told the mother", "the next beat", "keeping it moving"],
        examples: [
          "¿Y después? ¿Le dijo a tu mamá o te tocó a ti?",
          "¿Y después? ¿Qué dijo ella cuando se enteró?",
          "¿Y después? ¿Ya compró el pasaje o todavía no?",
        ],
      },
      {
        stem: "¿En serio?…",
        english: "Seriously? — not doubt, an invitation to continue",
        scenarios: ["the part that lands", "he's staying with her", "reacting so she keeps going"],
        examples: [
          "¿En serio? ¿Se va a quedar contigo?",
          "¿En serio? ¿En ese apartamento donde apenas cabes tú?",
          "¿En serio? ¿Y tú cuándo pensabas contarme esto?",
        ],
        note: "A repaso is the same five questions pointed the other way. All week Camila dug; today it's Marlana's turn, and it's five questions to one sentence.",
      },
    ],
  },
];
