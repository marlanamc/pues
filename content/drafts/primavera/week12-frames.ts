...
export const priWeek12FrameDays: FrameDay[] = [
  ...
  {
    day: 357,
    theme: "Conversación larga II: En el carro de Rocío",
    subtitle: "A ride home in Friday traffic. The conversation keeps almost ending and never does.",
    frames: [
      {
        stem: "Bueno, ¿y qué más?…",
        english: "Okay, so what else? — the gentlest restart there is",
        scenarios: ["twenty minutes of traffic left", "the lull", "reopening with nothing"],
        examples: [
          "Bueno, ¿y qué más? Todavía nos quedan veinte minutos de tráfico.",
          "Bueno, ¿y qué más? Algo que no sea del colegio.",
          "Bueno, ¿y qué más? Cuéntame cualquier cosa.",
        ],
      },
      {
        stem: "Se me olvidaba contarte…",
        english: "I forgot to tell you…",
        scenarios: ["the copier, finally", "rescuing news from the day", "small work gossip"],
        examples: [
          "Se me olvidaba contarte que por fin arreglaron la copiadora.",
          "Se me olvidaba contarte que la directora me paró en el pasillo.",
          "Se me olvidaba contarte que Yesenia trajo pan otra vez.",
        ],
      },
      {
        stem: "Oye, y cambiando de tema…",
        english: "Hey, changing the subject…",
        scenarios: ["her landlord", "leaving a dead thread alone", "opening a different door"],
        examples: [
          "Oye, y cambiando de tema, ¿cómo te fue con el casero?",
          "Oye, y cambiando de tema, ¿tu hija ya decidió lo de la universidad?",
          "Oye, y cambiando de tema, ¿tú vas el sábado o no?",
        ],
        note: "Don't revive a thread that died. Open a different one — that's what this stem is for, and it's why long conversations survive silences.",
      },
      {
        stem: "Por cierto…",
        english: "By the way…",
        scenarios: ["the observation from the window", "the wrong turn", "noticing something out loud"],
        examples: [
          "Por cierto, este no es el camino a mi casa.",
          "Por cierto, vi a tu vecino en la panadería el martes.",
          "Por cierto, se te está acabando la gasolina.",
        ],
      },
      {
        stem: "Ah, y otra cosa…",
        english: "Oh, and one more thing…",
        scenarios: ["at the curb", "the last thing before getting out", "delaying the goodbye"],
        examples: [
          "Ah, y otra cosa, no me dejes en la esquina, que está lloviendo.",
          "Ah, y otra cosa, mañana no vengas a buscarme, voy en tren.",
          "Ah, y otra cosa — el lunes te devuelvo el libro, de verdad.",
        ],
      },
    ],
  },
