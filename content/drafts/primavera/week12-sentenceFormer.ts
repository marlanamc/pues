...
export const priWeek12SentenceFormerDays: SentenceFormerDay[] = [
  ...
  {
    day: 357,
    theme: "Repaso: Conversación larga II",
    stems: [
      {
        stem: "Bueno, ¿y qué más?…",
        english: "Well, what else?… / So, anything else?…",
        completions: [
          { es: "el stem más simple y el más útil", en: "the simplest stem and the most useful", category: "opinion" },
          { es: "no es pereza, es invitación", en: "it's not laziness, it's invitation", category: "opinion" },
          { es: "¿qué más te quedó de la llamada de ayer?", en: "what else stayed with you from yesterday's call?", category: "other" },
          { es: "¿qué más toca para el capstone?", en: "what else is needed for the capstone?", category: "other" },
          { es: "cuéntame qué sigue", en: "tell me what's next", category: "activity" },
        ],
      },
      {
        stem: "Se me olvidaba contarte…",
        english: "I forgot to tell you… / I was forgetting to tell you…",
        completions: [
          { es: "rescata lo que casi se pierde", en: "it rescues what almost gets lost", category: "opinion" },
          { es: "lo de yesenia salvó el silencio", en: "the yesenia thing saved the silence", category: "other" },
          { es: "el imperfecto avisa que iba a olvidarse", en: "the imperfect signals it was about to be forgotten", category: "other" },
          { es: "casi cuelgo sin decirte", en: "i almost hung up without telling you", category: "activity" },
          { es: "la memoria relanza mejor que la inteligencia", en: "memory relaunches better than intelligence", category: "opinion" },
        ],
      },
      {
        stem: "Oye, y cambiando de tema…",
        english: "Hey, and changing the subject… / Speaking of something else…",
        completions: [
          { es: "no revivas lo muerto, abre otro", en: "don't revive what's dead, open another", category: "opinion" },
          { es: "cuando el hospital ya no da más", en: "when the hospital has nothing left", category: "other" },
          { es: "permiso sin disculpa", en: "permission without apology", category: "opinion" },
          { es: "el giro deliberado", en: "the deliberate pivot", category: "other" },
          { es: "cuando ¿y qué más? no cae", en: "when \"what else?\" doesn't land", category: "activity" },
        ],
      },
      {
        stem: "Por cierto…",
        english: "By the way… / Incidentally…",
        completions: [
          { es: "el relanzamiento más suave de los cinco", en: "the gentlest relaunch of the five", category: "opinion" },
          { es: "doña marta abrió veinte minutos de charla", en: "doña marta opened twenty minutes of talk", category: "time" },
          { es: "no exige respuesta; la invita", en: "it doesn't demand an answer; it invites one", category: "opinion" },
          { es: "la tangente más larga de la llamada", en: "the longest tangent of the call", category: "other" },
          { es: "vi a tu vecina en la panadería", en: "i saw your neighbor at the bakery", category: "other" },
        ],
      },
      {
        ...
        english: "Oh, and one more thing… / Ah, and another thing…",
        completions: [
          { es: "dijiste que colgabas y llevamos noventa minutos", en: "you said you'd hang up and we're at ninety minutes", category: "time" },
          { es: "así se calienta cuando se enfría", en: "that's how it warms up when it cools down", category: "other" },
          { es: "antes del capstone — ya casi", en: "before the capstone — almost there", category: "time" },
          { es: "el stack es calor, no rudeza", en: "the stack is warmth, not rudeness", category: "opinion" },
          { es: "no estoy lista para colgar", en: "i'm not ready to hang up", category: "other" },
        ],
      },
    ],
  },
