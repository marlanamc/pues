...
export const priWeek4FrameDays: FrameDay[] = [
  ...
  {
    day: 301,
    theme: "Historias con sabor: El perro de la vecina",
    subtitle: "She got home at nine and there was a dog in her kitchen. A whole new story, same five gears.",
    frames: [
      {
        stem: "No te vas a creer lo que…",
        english: "You're not going to believe what…",
        scenarios: ["opening the door", "the hook", "starting a story cold"],
        examples: [
          "No te vas a creer lo que encontré cuando abrí la puerta.",
          "No te vas a creer lo que había debajo de la mesa.",
          "No te vas a creer lo que me pasó anoche a las nueve.",
        ],
      },
      {
        stem: "Para colmo…",
        english: "And on top of that… / To make it worse…",
        scenarios: ["the second problem", "stacking bad luck", "nobody answering"],
        examples: [
          "Para colmo, la vecina no contestaba el teléfono.",
          "Para colmo, yo venía cargada con las bolsas.",
          "Para colmo, se me había acabado la batería.",
        ],
      },
      {
        stem: "Y de repente, ¡pum!",
        english: "And suddenly, bam!",
        scenarios: ["the turn", "the dog appears", "the moment the story wakes up"],
        examples: [
          "Y de repente, ¡pum!, el perro sale de debajo de la cama.",
          "Y de repente, ¡pum!, se abre la puerta del baño sola.",
          "Y de repente, ¡pum!, se me tira encima y me lame la cara.",
        ],
      },
      {
        stem: "Y lo peor es que…",
        english: "And the worst part is…",
        scenarios: ["the damage report", "the bread", "what he'd already done"],
        examples: [
          "Y lo peor es que ya se había comido medio pan.",
          "Y lo peor es que dejó pelos en toda la cama.",
          "Y lo peor es que ahora quiere volver todos los días.",
        ],
      },
      {
        stem: "Imagínate que…",
        english: "Just imagine that… / Picture this…",
        scenarios: ["putting the listener in the room", "the closing move", "handing over the scene"],
        examples: [
          "Imagínate que llegas a las nueve y hay un perro en tu cocina.",
          "Imagínate que no sabes de quién es y te mira como si fueras tú la visita.",
          "Imagínate que tocas la puerta de la vecina con el perro en brazos.",
        ],
        note: "A repaso is a brand-new story, not a summary of the old one. Same five gears, a dog instead of an elevator.",
      },
    ],
  },
];
