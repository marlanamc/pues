...
export const priWeek3FrameDays: FrameDay[] = [
  ...
  },
  {
    ...
    subtitle: "Six days of commute color — say what exaggeration gave you that the clock couldn't.",
    frames: [
      {
        stem: "Me muero de…",
        english: "I'm dying of… / I'm so… (hyperbolic)",
        scenarios: ["the week's favorite ending", "what you say now automatically", "not literally, ever"],
        examples: [
          "Me muero de ganas de usar esto en la vida real.",
          "Me muero de risa cuando lo digo en voz alta.",
          "Me muero de sueño, sí, pero ahora suena a mí.",
        ],
      },
      {
        stem: "Tardé mil años",
        english: "It took me forever / A thousand years",
        scenarios: ["the stem that replaced minutes", "story time vs clock time", "the week's winner"],
        examples: [
          "Tardé mil años se convirtió en mi forma de contar el tiempo.",
          "Tardé mil años y nadie me pidió el reloj.",
          "Tardé mil años: la frase más útil del metro.",
        ],
      },
      {
        stem: "Es lo mejor del mundo",
        english: "It's the best thing in the world",
        scenarios: ["small things, big phrases", "what you praised this week", "sincere and theatrical"],
        examples: [
          "Es lo mejor del mundo exagerar sin mentir.",
          "Es lo mejor del mundo que Camila me enseñara esto.",
          "Es lo mejor del mundo que suene a conversación, no a reporte.",
        ],
      },
      {
        stem: "Es lo peor del mundo",
        english: "It's the worst thing in the world",
        scenarios: ["complaining with style", "the disaster day", "permission to feel it"],
        examples: [
          "Es lo peor del mundo, y está bien decirlo así.",
          "Es lo peor del mundo cuando lo minimizas por educación.",
          "Es lo peor del mundo, pero suena humano.",
        ],
      },
      {
        stem: "Es una barbaridad",
        english: "It's outrageous / It's absurd",
        scenarios: ["the week's closing line", "outrage with a smile", "what Rocío added"],
        examples: [
          "Es una barbaridad lo mucho que cambió mi forma de quejarme.",
          "Es una barbaridad, dijo Rocío, y tenía razón.",
          "Es una barbaridad, y por eso me gusta.",
        ],
        note: "The week's lesson: hyperbole isn't lying — it's giving the feeling the size it actually had inside you.",
      },
    ],
  },
];
