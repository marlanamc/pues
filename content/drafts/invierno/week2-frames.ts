...
export const invWeek2FrameDays: FrameDay[] = [
  {
    ...
    frames: [
      ...
      },
      {
        ...
        examples: [
          "Total, que ya tengo cinco palabras nuevas.",
          "Total, que voy a usarlas toda la semana.",
          "Total, que el jueves te cuento cómo me fue.",
        ],
        note: "*Total, que* is the exit door from a long story. Say it and everyone knows the ending has started.",
      },
    ],
  },
  {
    ...
    frames: [
      ...
      },
      {
        ...
        examples: [
          "Total, que el jueves se volvió mi día favorito.",
          "Total, que no pienso faltar.",
          "Total, que te agradezco más de lo que parece.",
        ],
      },
    ],
  },
  {
    ...
    frames: [
      ...
      },
      {
        ...
        examples: [
          "Total, que un \"digo\" me arregla la frase entera.",
          "Total, que ya no vuelvo al principio.",
          "Total, que corrijo sin cortar la conversación.",
        ],
      },
    ],
  },
  {
    ...
    frames: [
      ...
      },
      {
        ...
        examples: [
          "Total, que dimos la clase en la biblioteca.",
          "Total, que se resolvió, pero mal.",
          "Total, que ahora reviso el horario cada mañana.",
        ],
      },
    ],
  },
  {
    ...
    frames: [
      ...
      },
      {
        ...
        examples: [
          "Total, que salí de ahí con más preguntas que al entrar.",
          "Total, que vamos a repetir la reunión el jueves.",
          "Total, que no pude venir temprano por eso.",
        ],
        note: "A story can be long if the landing is clean. *Total, que* is the landing.",
      },
    ],
  },
  {
    ...
    frames: [
      ...
      },
      {
        ...
        examples: [
          "Total, que voy a decir \"claro\" y \"exacto\" más seguido.",
          "Total, que también se conversa mientras el otro habla.",
          "Total, que me faltaba la mitad de la conversación.",
        ],
      },
    ],
  },
  {
    ...
    frames: [
      ...
      },
      {
        ...
        examples: [
          "Total, que dos semanas y ya sueno distinta.",
          "Total, que la próxima toca el teléfono.",
          "Total, que sigo el jueves que viene.",
        ],
      },
    ],
  },
