...
export const preguntas: VocabTheme = {
  ...
  words: [
    ...
    { id: "v-preguntas-por-que", es: "por qué", en: "why", example: "¿Por qué nadie avisó que se cancelaba?", exampleEn: "Why did nobody say it was cancelled?" },
...
export const preposiciones: VocabTheme = {
  ...
  words: [
    ...
    { id: "v-preposiciones-a-alguien", es: "a", en: "a (someone)", example: "Ayer vi a mi hermana en el tren.", exampleEn: "Yesterday I saw my sister on the train." },
    ...
    { id: "v-preposiciones-en", es: "en", en: "in / on / at", example: "Dejé el cuaderno en la mesa del fondo.", exampleEn: "I left the notebook on the table at the back." },
    ...
    { id: "v-preposiciones-por", es: "por", en: "for / through / because of", example: "Pasé por tu casa y no había nadie.", exampleEn: "I went by your house and nobody was there." },
    { id: "v-preposiciones-para", es: "para", en: "for / in order to", example: "Esto es para ti, no lo abras todavía.", exampleEn: "This is for you — don't open it yet." },
    { id: "v-preposiciones-sobre", es: "sobre", en: "on / about", example: "Hablamos sobre el examen y se nos fue la hora.", exampleEn: "We talked about the exam and the hour got away from us." },
    { id: "v-preposiciones-entre", es: "entre", en: "between / among", example: "El secreto quedó entre nosotras dos.", exampleEn: "The secret stayed between the two of us." },
...
export const conectores: VocabTheme = {
  ...
  labelEn: "Connectors",
  words: [
    { id: "v-conectores-porque", es: "porque", en: "because", example: "No vine porque se me durmió el despertador.", exampleEn: "I didn't come because my alarm slept in." },
    { id: "v-conectores-cuando", es: "cuando", en: "when (as)", example: "Cuando termina la clase, me quedo un rato.", exampleEn: "When class ends, I stay a little while." },
    { id: "v-conectores-como", es: "como", en: "like / as", example: "Dilo como si nadie te estuviera oyendo.", exampleEn: "Say it as if nobody were listening to you." },
    { id: "v-conectores-si", es: "si", en: "if", example: "Si llueve, damos la clase igual.", exampleEn: "If it rains, we hold class anyway." },
    { id: "v-conectores-pero", es: "pero", en: "but", example: "Quería ir, pero se me hizo tarde.", exampleEn: "I wanted to go, but I ran late." },
    { id: "v-conectores-aunque", es: "aunque", en: "even though", example: "Voy aunque llegue diez minutos tarde.", exampleEn: "I'm going even if I arrive ten minutes late." },
    { id: "v-conectores-donde", es: "donde", en: "where (at which)", example: "El salón donde damos clase no tiene ventanas.", exampleEn: "The room where we have class has no windows." },
  ],
};
