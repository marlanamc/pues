...
/**
 * Sentence Former banks (Verano / summer), days 1–91.
 *
 * Moved verbatim from the original content/sentenceFormer.ts at the Otoño
 * boundary (see content/CURRICULUM.md convention 7).
 */
export const veranoSentenceFormerDays: SentenceFormerDay[] = [
  {
    day: 1,
    theme: "Wants & Plans",
    stems: [
