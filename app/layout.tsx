  ...
  return (
    ...
    >
      <body className="min-h-dvh bg-bg text-ink antialiased">
        ...
        <TextSizeBootstrap />
        <TopNav />
        <main className="w-full px-6 pt-2 pb-28 lg:px-0 lg:pt-4 lg:pb-12">
          <div className="mx-auto flex w-full max-w-[520px] flex-1 flex-col md:max-w-[56rem] lg:max-w-[1400px] lg:px-8">
            {children}
          </div>
        </main>
        <BottomTabNav />
